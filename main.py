...
for epoch in range(100):
    ...
    for x1_batch, x2_batch, label_batch in dataloader:
        ...
        # Contrastive loss to align view representations
        loss_c = contrastive_loss(z1, z2)

        # Reconstruction loss using ground-truth labels (supervised signal)
...
with torch.no_grad():
    ...
    # Apply KMeans clustering to learned features
